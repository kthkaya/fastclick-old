qemu-system-x86_64 \
    ...
    -drive file="/var/lib/libvirt/images/NF-clone-clone.qcow2",if=virtio,aio=threads \
    -chardev socket,id=char1,path=/usr/local/var/run/openvswitch/SNK \
    ...
    -device virtio-net-pci,mac=00:00:11:00:00:03,netdev=tapnet0 \
